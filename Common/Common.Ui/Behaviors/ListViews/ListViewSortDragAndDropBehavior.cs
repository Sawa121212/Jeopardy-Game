...
{
    /// <summary>
    /// Сортирует список элементов в ListView
    /// </summary>
    public class ListViewSortDragAndDropBehavior : Behavior<ListView>, IDragAndDropBehavior
    {
        public static readonly DependencyProperty ItemsProperty = DependencyProperty.Register(
            nameof(Items), typeof(ICollection), typeof(ListViewSortDragAndDropBehavior), new PropertyMetadata(default(IList)));
