...
namespace Common.Extensions.ValueTypes
{
    /// <summary>
    ...
    public static class DateTimeExtensions
    {
        ...
        /*
         TODO: Прежнее местоположение: DataBase.Domain/Utils/ScadaUtils/TypeUtils/DateTimeHelper.cs.
         В старых методах отсутствовал параметр culture.
        */
        ...
        public static bool IsDate(this string s, CultureInfo culture = null)
        {
            ...
            return DateTime.TryParse(s, culture, DateTimeStyles.None, out DateTime dateTime) &&
        ...
        public static DateTime ToDate(this string s, CultureInfo culture = null)
        {
            ...
            if (DateTime.TryParse(s, culture, DateTimeStyles.None, out DateTime dateTime) && 
                    dateTime.TimeOfDay.TotalMilliseconds == 0)
        ...
        /// <see cref="CultureInfo">CultureInfo</see>.
        /// </summary>
        // TODO: Бывший Localization.ToLocalizedDateString
        public static string StrFromDate(this DateTime dt, CultureInfo culture = null)
        {
            ...
            int indB = dateFormat.IndexOf('y');
            int indE = dateFormat.LastIndexOf('y');
            int count = indE - indB + 1;
            if (indB > -1 && count != 4)
            {
        ...
        /// </summary>
        // TODO: Бывший Localization.ToLocalizedTimeString
        public static string StrFromTime(this DateTime dateTime, CultureInfo culture = null, bool isIncludingMs = false)
        {
            ...
            int indB = timeFormat.IndexOf('h');
            int indE = timeFormat.LastIndexOf('h');
            int count = indE - indB + 1;
            if (indB > -1 && count != 2)
            {
        ...
        // TODO: Бывший Localization.ToLocalizedString
        ...
        {
            string? dateStr = dateTime.StrFromDate(culture);
            string? timeStr = dateTime.StrFromTime(culture, isIncludingMs);
        ...
        /// <see cref="CultureInfo">CultureInfo</see>.
        /// </summary>
        // TODO: Бывший Localization.GetLocalizedYear
