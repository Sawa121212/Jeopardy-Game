...
namespace Common.Extensions.ValueTypes
{
    ...
    public static class DoubleExtensions
    {
        ...
        public static NumberFormatInfo NfiComma
        {
            get
            {
                NumberFormatInfo? nfiRus = (NumberFormatInfo)CultureInfo.GetCultureInfo("ru-RU").NumberFormat.Clone();
        ...
        public static double ToDouble(this string str, bool isThrowException = false)
        {
            ...
            if (str.TryParseDouble(out double result))
                return result;
        ...
        public static double ToDouble(this string str, CultureInfo culture, bool isThrowException = false)
        {
            ...
            string? normalized = str.IsNullOrEmpty()
                ? str
