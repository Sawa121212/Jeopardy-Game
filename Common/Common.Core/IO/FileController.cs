...
namespace Common.Core.IO
{
    ...
    public class FileController
    {
        ...
        {
            bool checkC = CheckCapacity();
            bool checkCd = CheckCreationDate();
            bool checkFc = CheckFileCount();
        ...
        {
            HashSet<FileInfo>? oldFiles = Folder.GetOldFiles(OldestFileCreationDate).ToHashSet(new FileInfoComparer());
            OldFiles.UnionWith(oldFiles);
        ...
        {
            List<FileInfo>? oldFiles = Folder.GetOldFiles(MaxFileCount).ToList();
            OldFiles.UnionWith(oldFiles);
        ...
        public Components.Result<bool> RemoveOldFiles()
        {
            try
            {
                ...
                return Components.Result<bool>.Done(true);
            }
            catch (Exception e)
            {
                return Components.Result<bool>.Fail(e);
            }
        }
